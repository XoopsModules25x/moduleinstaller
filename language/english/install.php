...
define('UNINSTALLED_MODULES', 'The following modules have been uninstalled.<br />Press <strong>next</strong> to go to the next step.');
...
define('UPDATED_MODULES', 'The following modules have been updated.<br />Press <strong>next</strong> to go to the next step.');
